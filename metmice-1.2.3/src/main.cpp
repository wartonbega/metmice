...
{ // initie des variables de base
	Mtmc_variable *v = new_mtmc_variable_from_string(mtmc_version);
	Mtmc_variable *d = new_mtmc_variable_from_string(mtmc_version_date);

	variable_asignement(v, "mtmc_version");
	variable_asignement(d, "mtmc_version_date");
}
