        ...
        else if (instruction->value == "if_statement")
        {
            ...
            if (!function)
            {
                ...
                if (cond == "true")
                {
                    ...
                    normal_code_execution(paterns, 0, variable_function, 0); // Qui correspond au {}
                }
                else if (instruction->children.size() > 3 and instruction->children[3]->value == "else")
                {
                    ...
                    normal_code_execution(paterns, 0, variable_function, 0); // Qui correspond au {} du else statement
                }
            }
            else
            {
                ...
                {
                    vector<Node *> paterns = recognize_paternes(instruction->children[2], true);
                    result = normal_code_execution(paterns, function, variable_function, 0); // Qui correspond au {}
                }
                else if (instruction->children.size() > 3 and instruction->children[3]->value == "else")
                {
                    vector<Node *> paterns = recognize_paternes(instruction->children[4], true);
                    result = normal_code_execution(paterns, function, variable_function, 0); // Qui correspond au {} du else statement
                }
                if (result == "return")
                {
                    return "return";
